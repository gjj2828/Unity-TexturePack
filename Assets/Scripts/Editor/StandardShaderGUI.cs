...
namespace UnityEditor
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent metallicAoMapText = EditorGUIUtility.TrTextContent("Metallic & AO", "Metallic (R) and AO (G) and Smoothness (A)");
        ...
        MaterialProperty metallicAoMap = null;
        ...
        static int _MetallicAoMap = Shader.PropertyToID("_MetallicAoMap");
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            metallicAoMap = FindProperty("_MetallicAoMap", props, false);
            specularMap = FindProperty("_SpecGlossMap", props, false);
            specularColor = FindProperty("_SpecColor", props, false);
            metallicMap = FindProperty("_MetallicGlossMap", props, false);
            metallic = FindProperty("_Metallic", props, false);
            if (metallicAoMap != null)
            {
                m_WorkflowMode = WorkflowMode.MetallicAo;
            }
        ...
        public void ShaderPropertiesGUI(Material material)
        {
...

            {
                ...
                if (m_WorkflowMode != WorkflowMode.MetallicAo)
                {
        ...
        internal void DetermineWorkflow(Material material)
        {
            ...
            if (ShaderHasProperty(shader, _MetallicAoMap))
            {
                m_WorkflowMode = WorkflowMode.MetallicAo;
            }
            else if (ShaderHasProperty(shader, _SpecGlossMap) && ShaderHasProperty(shader, _SpecColor))
                m_WorkflowMode = WorkflowMode.Specular;
        ...
        void DoSpecularMetallicArea()
        {
            ...
            if (m_WorkflowMode == WorkflowMode.MetallicAo)
            {
                hasGlossMap = metallicAoMap.textureValue != null;
                m_MaterialEditor.TexturePropertySingleLine(Styles.metallicAoMapText, metallicAoMap, hasGlossMap ? occlusionStrength : specularColor);
            }
        ...
        static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
        {
            ...
            if (workflowMode == WorkflowMode.MetallicAo)
            {
                SetKeyword(material, "_METALLICAOMAP", material.GetTexture("_MetallicAoMap"));
            }
